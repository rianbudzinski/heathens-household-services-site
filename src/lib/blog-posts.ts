...
export const BLOG_POSTS: BlogPost[] = [
  {
    ...
    paragraphs: [
      "Home and business owners across Western New York often juggle multiple trades for one project: demolition, framing, exterior work, concrete, landscaping, and finish carpentry. Working with a single team that understands local weather, soil, and building styles can save time, reduce miscommunication, and keep your timeline realistic from estimate to walkthrough.",
